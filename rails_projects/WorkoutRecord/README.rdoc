...
I created the app to serve as a substitute for an Excel based workout record. A rails app offered increased functionality, better visualization options, and an easier way to dynamically update data.
...
Guests can log into a sample dataset using -  guest / pa$$w0rd
___
