...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { date_completed: @workout.date_completed, name: @workout.name, time: @workout.time }
    end
  ...
  test "should update workout" do
    put :update, id: @workout, workout: { date_completed: @workout.date_completed, name: @workout.name, time: @workout.time }
    assert_redirected_to workout_path(assigns(:workout))
  end
